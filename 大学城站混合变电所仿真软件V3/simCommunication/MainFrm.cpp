...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND(ID_TRAIN_FREE, OnTrainFree)
	ON_UPDATE_COMMAND_UI(ID_TRAIN_FREE, OnUpdateTrainFree)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CMainFrame::OnTrainFree() 
{
  CDlgFreeTrainList dlg;
  dlg.DoModal();
}

void CMainFrame::OnUpdateTrainFree(CCmdUI* pCmdUI) 
{
  if(g_SimTrain.SimTrainState!=0)
    pCmdUI->Enable(FALSE);
  else
