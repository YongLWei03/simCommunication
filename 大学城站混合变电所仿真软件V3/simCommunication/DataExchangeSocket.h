...
extern CDataExchangeSocket g_DataExchangePowerStateSocketOther;

struct TagDataExchangeStruct;
extern TagDataExchangeStruct g_DataExchangeList[256];     //本所数据交换列表
extern TagDataExchangeStruct g_DataExchangeListOther[256];//外所数据交换列表
